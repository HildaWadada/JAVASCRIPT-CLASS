...
console.log(MyBirthdayis ${myBirthday});

let Birthday = new Date(2005, 6, 11);
console.log(MyBirthdayis ${Birthday} + 1);
...
stalkQuantity--;
console.log(StalkLeftis${stalkQuantity});

let productSold = 0;
productSold++;
console.log(TotalProductSoldToday ${productSold});
...
stalkQuantityTwo -= 2;
console.log(StockSold ${stalkQuantityTwo});
